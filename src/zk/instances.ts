import aggregatePublicKeysCircuit from '../../circuits/aggregate_public_keys/aggregate_public_keys.json';
...
export const aggregatePublicKeys = new ThreadSafeCircuit(aggregatePublicKeysCircuit);
